...
There are specific algorithms that can be used to find voids, filaments or sheets \citep{Novikov2003,Zhang2009,Sousbie2010,Chen2015,Luber2019,Aragon-Calvo2019}, but a generic approach to predict the cosmic web
...
\citep{Klypin2003,Kitaura2009,Bos2014,LeclercqJasche2015,Wang2016,Simola2018,Burchett2020}. 
Either way, dark matter reconstruction remains computationally expensive task.

%{\textbf{Seguro hay mas referencias de reconstrucciones y red cósmica, hay que buscar un poco mas para extender este párrafo}}

Some methods make the classification of the cosmic web directly using the distribution of halos or galaxies computing a relative density related to the amount galaxies on a grid, these methods commonly use the Delaunay tessellation field estimator (DTFE) \citep{Aragon-Calvo2007,Aragon-Calvo2010} or NEXUS \citep{Cautun2013} an evolution of DTFE. Recent efforts have used machine learning to make this reconstruction \citep{Hui2018}.

%{\textbf{Hace falta un parrafo completo de los trabajos que usan galaxies para hacer la descomposicion completa en peak, filament, sheet y void.}}
