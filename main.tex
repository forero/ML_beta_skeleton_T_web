...
From the box simulation, we select randomly a 50$\%$ of galaxies 
...
We only selected the galaxies located 5 Mpc away from the box limits
to avoid boundary effects comming from incomplete $\beta$-skeleton
information.
As performance metrics we compute the precision, recall and the F1 score
