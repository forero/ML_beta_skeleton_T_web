...
A first approach performsthe reconstruction of the dark matter around
the galaxies, while the second directly interpolates galaxy position
on a grid to process this interpolated field in the same way as dark
matter densities. 
The first approach is computationaly expensive, while the second has
large physical uncertainties. 
