...
\begin{figure*}
    \includegraphics[scale=0.46]{Figs/p_F1_curve_Forest.pdf}
    \caption{Behaviour of the F1 score as a function of the number of estimators (NE) in the Random Forest.} 
    \label{fig:F1_curve}
\end{figure*}
